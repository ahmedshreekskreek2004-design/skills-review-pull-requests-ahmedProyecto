...
1. Click the **Add a suggestion** button to insert a modifiable copy of the line.
   ...
   <img width="300" alt="add-a-suggestion-button" src="https://github.com/ahmedshreekskreek2004-design/skills-review-pull-requests-ahmedProyecto/blob/main/.github/images/add-a-suggestion-button.png?raw=true" />
